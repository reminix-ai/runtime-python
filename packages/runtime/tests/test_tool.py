...
class TestToolDecorator:
    ...
    def test_tool_decorator_with_arguments(self):
        ...
        assert my_tool.metadata["description"] == "Custom description"
    ...
    def test_tool_description_from_docstring(self):
        ...
        assert get_weather.metadata["description"] == "Get the current weather for a location."
    ...
    def test_tool_description_multiline_docstring(self):
        ...
        assert get_weather.metadata["description"] == "Get the current weather."
